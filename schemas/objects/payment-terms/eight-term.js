...
export default {
    name: 'eightTermPayment',
    title: 'Eight Term Payment',
    type: 'object',
    icon: FaCalendarAlt,
    fields: [
        {
    ...
    preview: {
        ...
        prepare: (selection) => ({
            title: `Eight Term Payment -- Down Payment: ${new Intl.NumberFormat(
                'en-US',
                {
                    style: 'currency',
                    currency: 'PHP',
            ...
            subtitle: `Total: ${new Intl.NumberFormat('en-US', {
                ...
                selection.term7Payment + selection.term8Payment
            )}`,
        }),
    },
};
